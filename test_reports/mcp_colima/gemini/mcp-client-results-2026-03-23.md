...
Caveat:
- This report is generated from reproducible local MCP baseline execution evidence in mcp/colima-macos-mcp/test_reports/colima_baseline_results.json. A native interactive Gemini run can be added later for UI-level parity evidence.
